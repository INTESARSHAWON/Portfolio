  ...
  return (
    <div className='navbar'>
        ...
        <ul ref={menuRef} className='nav-menu'>
            ...
            <li><AnchorLink className='anchor-link' offset={50} href='#services'><p onClick={()=> setMenu('services')}>Skills</p></AnchorLink>{menu === 'services' ? <img src={underline} alt='underline'/> : <></>}</li>
